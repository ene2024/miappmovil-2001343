 ...
 */
import { r as registerInstance, h, H as Host, f as getElement, d as createEvent, e as readTask, i as forceUpdate, w as writeTask } from './index-eab5468b.js';
import { shouldUseCloseWatcher } from './hardware-back-button-36f7543b.js';
import { p as printIonWarning } from './index-9b0d46f4.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-c836c8c6.js';
...
import { t as transition } from './index-84ee782d.js';
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-da5c40cc.js').then((module) => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    ...
                    import('./input-shims-5329bbe8.js').then((module) => module.startInputShims(config, platform));
                }
                const hardwareBackButtonModule = await import('./hardware-back-button-36f7543b.js');
...
const RouterOutlet = class {
    ...
    render() {
        return h("slot", { key: '69b452a0dc0c10440bdd8700cf4843c43154c707' });
    }
    get el() { return getElement(this); }
