...
const TabBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e2b4b50270f171ed251359df6c65c5e7e4d526a4', role: "tablist", "aria-hidden": shouldHide ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
                'tab-bar-translucent': translucent,
                'tab-bar-hidden': shouldHide,
            }) }, index.h("slot", { key: '37495b2eddd01a758ceaeb36426abc9bd20bcca3' })));
    }
...
const TabButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9926f9392e7910ff3159397e4f907e0d7d2cf5a0', onClick: this.onClick, onKeyup: this.onKeyUp, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                [mode]: true,
                ...
                'ion-selectable': true,
                'ion-focusable': true,
            } }, index.h("a", Object.assign({ key: '4b3ace749583a5502e94462f9a70c5158fe0194a' }, attrs, { class: "button-native", part: "native", role: "tab", "aria-selected": selected ? 'true' : null, "aria-disabled": disabled ? 'true' : null, tabindex: disabled ? '-1' : undefined }, inheritedAttributes), index.h("span", { key: 'a2a30c02fbd5052da12586a5ab00a45f3bf53b88', class: "button-inner" }, index.h("slot", { key: '3fb22ffbb09000d99537b531220c029330ae6940' })), mode === 'md' && index.h("ion-ripple-effect", { type: "unbounded" }))));
    }
    get el() { return index.getElement(this); }
};
TabButton.style = {
