...
const Radio = class {
    ...
    renderRadio() {
        ...
        return (index.h(index.Host, { onFocus: this.onFocus, onBlur: this.onBlur, onClick: this.onClick, class: theme.createColorClasses(color, {
            ...
            }, part: "label" }, index.h("slot", null)), index.h("div", { class: "native-wrapper" }, this.renderRadioControl()))));
    }
    renderLegacyRadio() {
...
const RadioGroup = class {
    ...
    render() {
        ...
        return index.h(index.Host, { key: 'd8e84feca8f4dbe7605bc4ad096b6e68b482ba68', role: "radiogroup", "aria-labelledby": label ? labelId : null, onClick: this.onClick, class: mode });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["valueChanged"]
