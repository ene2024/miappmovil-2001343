...
const index$1 = require('./index-676a122f.js');
const overlays = require('./overlays-d32575f9.js');
...
const Menu = class {
    ...
    render() {
         ...
         */
        return (index.h(index.Host, { key: 'c6bf01fd87e31cda09c0c35900cb01ea19d61781', onKeyDown: hardwareBackButton.shouldUseCloseWatcher() ? null : this.onKeydown, role: "navigation", "aria-label": inheritedAttributes['aria-label'] || 'menu', class: {
                [mode]: true,
                [`menu-type-${type}`]: true,
                'menu-enabled': !disabled,
                [`menu-side-${side}`]: true,
                'menu-pane-visible': isPaneVisible,
            } }, index.h("div", { key: '6d818a470a74c11c10554d45d8586436a51f961e', class: "menu-inner", part: "container", ref: (el) => (this.menuInnerEl = el) }, index.h("slot", { key: '3512e444ec6c6bf2a719b1dd713be9a7652f77c9' })), index.h("ion-backdrop", { key: '618a5316462406fa47929e4dcd5a8e8c9057a418', ref: (el) => (this.backdropEl = el), class: "menu-backdrop", tappable: false, stopPropagation: false, part: "backdrop" })));
    }
...
const MenuButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2fd7130b8d28695162f7efebbd2131e5e9e4f330', onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
                ...
                'ion-focusable': true,
            }) }, index.h("button", Object.assign({ key: 'fa6b1fb9291df812b04065b4b0ebdfd28e5217eb' }, attrs, { disabled: disabled, class: "button-native", part: "native", "aria-label": ariaLabel }), index.h("span", { key: '88106a08070ebff7457c581301efe649829aded2', class: "button-inner" }, index.h("slot", { key: 'e3edfb89e5705b2c08c66f3d3452457667de3657' }, index.h("ion-icon", { key: '24678e9c3bb2f1f3db113a2ae0ec93e407a7de0c', part: "icon", icon: menuIcon, mode: mode, lazy: false, "aria-hidden": "true" }))), mode === 'md' && index.h("ion-ripple-effect", { type: "unbounded" }))));
    }
    get el() { return index.getElement(this); }
};
MenuButton.style = {
...
const MenuToggle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        const hidden = this.autoHide && !this.visible;
        return (index.h(index.Host, { key: '5b75baade530bf9e7ed9165a5db3e513975e22f2', onClick: this.onClick, "aria-hidden": hidden ? 'true' : null, class: {
                [mode]: true,
                'menu-toggle-hidden': hidden,
            } }, index.h("slot", { key: '65dea458274b685125c22af54aa153cf4977113c' })));
    }
};
