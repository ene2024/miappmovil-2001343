...
const index$1 = require('./index-ccddf5be.js');
...
const Nav = class {
    ...
    async componentDidLoad() {
        ...
        this.didLoad = true;
        this.rootChanged();
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-cf8aa1ec.js'); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
    ...
    render() {
        return index.h("slot", { key: '654286a8a7ef03d4a22497eb51e781a9a8979774' });
    }
...
const NavLink = class {
    ...
    render() {
        return index.h(index.Host, { key: 'a781794425ad0866705bc6691256184b93477a74', onClick: this.onClick });
    }
    get el() { return index.getElement(this); }
};
