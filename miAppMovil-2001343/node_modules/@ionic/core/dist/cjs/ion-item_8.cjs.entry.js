...
const Item = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '077c9ab04985292f79c30691151d2778a26285fb', "aria-disabled": ariaDisabled, class: Object.assign(Object.assign(Object.assign({}, childStyles), labelColorStyles), theme.createColorClasses(this.color, {
            ...
            })), role: inList ? 'listitem' : null }, index.h(TagType, Object.assign({ key: '08bb75c85d0584e9fb7f461e9e06b9b651ef3515' }, attrs, inheritedAriaAttributes, { class: "item-native", part: "native", disabled: disabled }, clickFn), index.h("slot", { key: '3f742b07c4a58eadedf675be4878a3e00070750e', name: "start" }), index.h("div", { key: '0160b8963434f3107856a2df2fb96f1abb4fdbfe', class: "item-inner" }, index.h("div", { key: '9439b21474443341f06a651d7c44aef90bd4c591', class: "input-wrapper" }, index.h("slot", { key: '8034e1337a6c950b7725bc9aa46d55de980827bf' })), index.h("slot", { key: '690de6d3dd3a238ab7a2d3dfea69daa6647e5134', name: "end" }), showDetail && (index.h("ion-icon", { icon: detailIcon, lazy: false, class: "item-detail-icon", part: "detail-icon", "aria-hidden": "true", "flip-rtl": detailIcon === index$1.chevronForward })), index.h("div", { key: 'e96885084ca845656fd4d18902528ce7de207c86', class: "item-inner-highlight" })), canActivate && mode === 'md' && index.h("ion-ripple-effect", null), index.h("div", { key: '64e5323c380e05aa183e8dd7fbe560d084725f5e', class: "item-highlight" })), index.h("div", { key: '677132e6193981697f494b215ddc02407fdd96a5', class: "item-bottom" }, index.h("slot", { key: 'cda34a9208020bbb18ca5313e0bfbf270f024012', name: "error" }), index.h("slot", { key: 'c1b3541b11ece13309d0e28dd3a95c048dfab43f', name: "helper" }), counterString && index.h("ion-note", { class: "item-counter" }, counterString))));
    }
...
const ItemDivider = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '8422b960dfcce4ff1370d9c185e285bb4a3688d5', class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-divider-sticky': this.sticky,
                item: true,
            }) }, index.h("slot", { key: '240514b96ec48262040460775c8eb0a58d6acfa8', name: "start" }), index.h("div", { key: 'ec18c092c81cb96f8c49ed7d4dede96c9a3e3f97', class: "item-divider-inner" }, index.h("div", { key: '9c3f3dcb9b14fd1d37fb1104b3ba953dc9a3e894', class: "item-divider-wrapper" }, index.h("slot", { key: '6b8e51eb86a5567b80a91034b26228105796a82d' })), index.h("slot", { key: '7ccb661e1309c1ecca09a823f8e08b1cf90d95dd', name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
ItemDivider.style = {
...
const ItemGroup = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'b33f23544ddeeeb61847b146b1dcb7a9ba30af18', role: "group", class: {
                [mode]: true,
...
const Label = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '813192a6460057c6d1e42f50f3f257bee2f550d8', class: theme.createColorClasses(this.color, {
                [mode]: true,
...
const List = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2cb1b689d9460d9576b471bb8b13d14fe34d1c2c', role: "list", class: {
                [mode]: true,
                // Used internally for styling
                [`list-${mode}`]: true,
                'list-inset': inset,
...
const ListHeader = class {
    ...
    render() {
        const { lines } = this;
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '1b832a6882307d40fe4afc9a95a5db4fbdff60a3', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`list-header-lines-${lines}`]: lines !== undefined,
            }) }, index.h("div", { key: 'a53a3f05727b510d1b912c10c92a4aa58f4fe860', class: "list-header-inner" }, index.h("slot", { key: '9377dee83f050b2cb2c5b7c5d106668cc81d8f90' }))));
    }
};
ListHeader.style = {
...
const Note = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'eebc0ea94483a248192408a1546739700281d2ae', class: theme.createColorClasses(this.color, {
                [mode]: true,
            }) }, index.h("slot", { key: '33018e11967398327a0e7c20522547a4d9e8f55b' })));
    }
};
Note.style = {
...
const SkeletonText = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'ee3cd9a5448fb69c8ddfc88a993f9968e1a381ff', class: {
                [mode]: true,
                'skeleton-text-animated': animated,
                'in-media': inMedia,
            } }, index.h("span", { key: '8aa792724a3b77877062e9aae838d9e1572b576f' }, "\u00A0")));
    }
    get el() { return index.getElement(this); }
};
