...
const Reorder = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e625707b1810f93f5c667e38b8e2904988a3cff0', class: mode }, index.h("slot", { key: 'fd0c3167e8a7955a6f841b338345de0528535ff5' }, index.h("ion-icon", { key: '3fc7bb1adb0dde839ec4898361e359c640e81067', icon: reorderIcon, lazy: false, class: "reorder-icon", part: "icon", "aria-hidden": "true" }))));
    }
...
const ReorderGroup = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '067b8ff26887c4e458163f70f7308723c90a53f8', class: {
                [mode]: true,
