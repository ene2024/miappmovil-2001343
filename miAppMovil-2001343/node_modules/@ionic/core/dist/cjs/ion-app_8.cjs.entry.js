...
const index = require('./index-c42c9063.js');
const hardwareBackButton = require('./hardware-back-button-b84c0758.js');
const index$1 = require('./index-5915f9b3.js');
const ionicGlobal = require('./ionic-global-34d0d04a.js');
...
const index$3 = require('./index-ccddf5be.js');
...
const App = class {
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (!ionicGlobal.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./index-62290fec.js'); }).then((module) => module.startTapClick(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-d9ebd6d3.js'); }).then((module) => module.startStatusTap());
                }
                if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
                    ...
                    Promise.resolve().then(function () { return require('./input-shims-a9a85bb9.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
                }
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-b84c0758.js'); });
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0ac01df6d90d8185017e1f8e8f02cdf407e6c94b', class: {
                [mode]: true,
                'ion-page': true,
...
const Buttons = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '52c0c5535f5688a481746fe8fd92b6c02941526f', class: {
                [mode]: true,
...
const Content = class {
    ...
    render() {
        ...
        this.resize();
        return (index.h(index.Host, { key: '65d85e1f7f85876a76eec79addc4bd9f697a5d84', class: theme.createColorClasses(this.color, {
                [mode]: true,
            ...
            } }, index.h("div", { key: 'e2ac474a62cbc864772c497469100436f41289ff', ref: (el) => (this.backgroundContentEl = el), id: "background-content", part: "background" }), index.h(TagType, { key: '567a4bc2bcb13adfd987b088f95ac4b20b789f2c', class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                overscroll: (scrollX || scrollY) && forceOverscroll,
            }, ref: (scrollEl) => (this.scrollEl = scrollEl), onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : undefined, part: "scroll" }, index.h("slot", { key: '13909f87dd9f49bf1664ad95038499da376b9480' })), transitionShadow ? (index.h("div", { class: "transition-effect" }, index.h("div", { class: "transition-cover" }), index.h("div", { class: "transition-shadow" }))) : null, index.h("slot", { key: '05b56c139e203cfd1e3dd08054e99328e97e9243', name: "fixed" })));
    }
    get el() { return index.getElement(this); }
};
...
const Footer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '550b8b8fb614e541e1d369fc1ac5ba1f083913b4', role: "contentinfo", class: {
                [mode]: true,
            ...
            } }, mode === 'ios' && translucent && index.h("div", { class: "footer-background" }), index.h("slot", { key: 'd25187ecc2ce7848ba882af078cb634e9d5e8814' })));
    }
    get el() { return index.getElement(this); }
};
Footer.style = {
...
const Header = class {
    ...
    render() {
        ...
        return (index.h(index.Host, Object.assign({ key: 'a33e7e1818cb4718ae36b8bcfa811c4138b85fac', role: roleType, class: {
                [mode]: true,
                // Used internally for styling
                [`header-${mode}`]: true,
            ...
            } }, inheritedAttributes), mode === 'ios' && translucent && index.h("div", { class: "header-background" }), index.h("slot", { key: '7e2fa75034f7422a3dc5691e9b3c25393e16c0ca' })));
    }
    get el() { return index.getElement(this); }
};
Header.style = {
...
const RouterOutlet = class {
    ...
    render() {
        return index.h("slot", { key: '69b452a0dc0c10440bdd8700cf4843c43154c707' });
    }
    get el() { return index.getElement(this); }
...
const ToolbarTitle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        const size = this.getSize();
        return (index.h(index.Host, { key: 'b68a272a33ec81d282629a569676f64d3215a0c7', class: theme.createColorClasses(this.color, {
                [mode]: true,
                [`title-${size}`]: true,
                'title-rtl': document.dir === 'rtl',
            }) }, index.h("div", { key: '9069816a14e6e358695c5bd465787cf297c761bc', class: "toolbar-title" }, index.h("slot", { key: '8894bd04f2292b54050ee864abb5396deadf9874' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "size": ["sizeChanged"]
...
const Toolbar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'afac0f08f3981483c072984ce047df5dc9cc1e99', class: Object.assign(Object.assign({}, childStyles), theme.createColorClasses(this.color, {
                [mode]: true,
                'in-toolbar': theme.hostContext('ion-toolbar', this.el),
            })) }, index.h("div", { key: '30d4f1d0ec01cc646398301b5f7d469391eb35d2', class: "toolbar-background" }), index.h("div", { key: '175d1f283e670b57a9bf8fd2a8c5e7d0da749aa8', class: "toolbar-container" }, index.h("slot", { key: '4853b18092737b32b5995457536fa5a7fc2816ef', name: "start" }), index.h("slot", { key: '6eb4921200aad02d7977d134edad6cff2aad91ad', name: "secondary" }), index.h("div", { key: '024e0339c74c4b9a886d49e96723243719643dc2', class: "toolbar-content" }, index.h("slot", { key: 'b6452c84692fedd6efe33ac67907d01253b76f8f' })), index.h("slot", { key: '636e56eeaa318ce45a9c3854a30b8eb2819a33e0', name: "primary" }), index.h("slot", { key: 'a45c19b93dca3719d75bd4d99acc49de87137a7d', name: "end" }))));
    }
    get el() { return index.getElement(this); }
};
Toolbar.style = {
