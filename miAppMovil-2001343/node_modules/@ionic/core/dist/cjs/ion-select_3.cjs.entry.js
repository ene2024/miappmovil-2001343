...
const Select = class {
    ...
    renderSelect() {
        ...
        return (index.h(index.Host, { onClick: this.onClick, class: theme.createColorClasses(this.color, {
            ...
            }) }, index.h("label", { class: "select-wrapper", id: "select-label" }, this.renderLabelContainer(), index.h("div", { class: "select-wrapper-inner" }, index.h("slot", { name: "start" }), index.h("div", { class: "native-wrapper", ref: (el) => (this.nativeWrapperEl = el), part: "container" }, this.renderSelectText(), this.renderListbox()), index.h("slot", { name: "end" }), !hasFloatingOrStackedLabel && this.renderSelectIcon()), hasFloatingOrStackedLabel && this.renderSelectIcon(), shouldRenderHighlight && index.h("div", { class: "select-highlight" }))));
    }
    // TODO FW-3194 - Remove this
    renderLegacySelect() {
...
const SelectOption = class {
    ...
    render() {
        return index.h(index.Host, { key: 'fe62f2d62ede6866e20969a2e7ae25453648fcef', role: "option", id: this.inputId, class: ionicGlobal.getIonMode(this) });
    }
    get el() { return index.getElement(this); }
};
...
const SelectPopover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9d3995131364d4f1d282e0a1fc34e778e94c9f98', class: ionicGlobal.getIonMode(this) }, index.h("ion-list", { key: '14244dcd6375eb61d65f3a9450d42a5d7b2d6541' }, header !== undefined && index.h("ion-list-header", null, header), hasSubHeaderOrMessage && (index.h("ion-item", null, index.h("ion-label", { class: "ion-text-wrap" }, subHeader !== undefined && index.h("h3", null, subHeader), message !== undefined && index.h("p", null, message)))), this.renderOptions(options))));
    }
    get el() { return index.getElement(this); }
};
SelectPopover.style = {
