...
const Avatar = class {
    ...
    render() {
        return (index.h(index.Host, { key: '95d7ca334f9b66e0983cbc1b782ded0b9a54eaa9', class: ionicGlobal.getIonMode(this) }, index.h("slot", { key: '011d20189acdb03bee328aa4fa0511826a0b3a36' })));
    }
};
Avatar.style = {
...
const Badge = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '043eea016721e53f0af1cbf1371bc08694281204', class: theme.createColorClasses(this.color, {
                [mode]: true,
            }) }, index.h("slot", { key: 'bd510450d6b60f2794491244e68a83049a5ef6dd' })));
    }
};
Badge.style = {
...
const Thumbnail = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2b3d5139161f4b9075dce537c14b4087986b37c4', class: ionicGlobal.getIonMode(this) }, index.h("slot", { key: '3c4838c43e1230f9413a3cb66584417fd11382b2' })));
    }
};
