...
const ItemOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8d8ef0455e0e46d31a84b6f9e83e377e0579f04b', onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
                'item-option-disabled': disabled,
                'item-option-expandable': expandable,
                'ion-activatable': true,
            }) }, index.h(TagType, Object.assign({ key: '0d4833cefd206862a75fdef8744e659cff24a39f' }, attrs, { class: "button-native", part: "native", disabled: disabled }), index.h("span", { key: 'bfbdab3ee6cfc884eb2bd60c92cf919f4b671c27', class: "button-inner" }, index.h("slot", { key: '968ebecbd9e8ca5015106d79e5d29b4a1999d39b', name: "top" }), index.h("div", { key: '38677cd72df6447a4e934695ab08857460be800d', class: "horizontal-wrapper" }, index.h("slot", { key: 'e65131d2e3f12c3743c7229b0a7f381824a45281', name: "start" }), index.h("slot", { key: 'c3a9bd83c455a79395574ff4d862299fd9340cd2', name: "icon-only" }), index.h("slot", { key: '161ca1daed265e8990d28f74744476a37d555d85' }), index.h("slot", { key: 'd5ecafceada1f8c3c16a2cb6511368828009081f', name: "end" })), index.h("slot", { key: '39e6a9dffc2cb9e2e9a200f6c669ed47f9a485aa', name: "bottom" })), mode === 'md' && index.h("ion-ripple-effect", null))));
    }
...
const ItemOptions = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '04d6baf62154da6ab9db5e679f982fe3fe276f89', class: {
                [mode]: true,
...
const ItemSliding = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'f666dd119a72247feac11dcd704059fce7677325', class: {
                [mode]: true,
